...
# Parameters
batch_size = 1  # Modify the batch size as needed TODO: Change this variable to change the batchsize

# Create a DataLoader
data_loader = DataLoader(
    dataset, 
    batch_size=batch_size, 
    shuffle=False  # Disable shuffle if order matters
)
...
macs, total_parameters = profile(model, inputs=(input_ids, attention_mask))
print("-----------------------------------------------------------")
